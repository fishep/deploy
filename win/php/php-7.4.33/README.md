...
#配置环境变量
#cmd
#set PHP_HOME=E:\usr\local\php\php-7.4.33
#set Path=%Path%;%PHP_HOME%
#powershell
$env:PHP_HOME = "E:\usr\local\php\php-7.4.33"
...
# 下载扩展库
#php_redis-5.3.7-7.4-nts-vc15-x64.zip
#php_xdebug-3.1.3-7.4-nts-vc15-x64.zip
