...
cd php-src
git checkout -b php-8.4.8 php-8.4.8
```
...
#### 安装
```shell
export PHP_HOME=~/usr/local/php/php-8.4.8
...
# 安装第三方扩展
wget https://pecl.php.net/get/redis-x.x.x.tgz  # 替换为最新版本
...
php composer-setup.php --install-dir=$PHP_HOME/bin/ --filename=composer
